...
public:
    ...
    /**
     * @brief getSolution returns a map containing all variables
     * generated by the solver, together with the corresponding
     * solution at the last call to update()
     */
...
protected:
    ...
    std::map<std::string, Eigen::VectorXd> _solution;
